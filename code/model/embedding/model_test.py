...
from model.embedding.setence_model.deepwalk import DeepWalk
from model.embedding.setence_model.line import Line
from model.embedding.setence_model.node2vec import node2vec
from model.embedding.setence_model.sdne import sdne
from model.embedding.util.util_tool import read_graph
from model.embedding.util.evaluate import evaluate_tools
...
def line_run():
    from util.util_tool import read_graph
    import os
    print(os.getcwd())
